    ...
    <div className="min-h-screen p-4">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="mt-2 text-gray-300 text-sm sm:text-base max-w-3xl">
          Här kan du läsa mer om de olika studentpubarna i Stockholm och föreningarna som driver
          dem.
        </p>
      ...
      {/* Modal */}
      {selected && <OrganizationModal org={selected} onClose={handleClose} />}
    </div>
  )
}
...
function Header() {
  return (
    <header className="flex items-center justify-between" role="banner">
      <h1 className="text-xl sm:text-2xl font-bold text-white">Klubbmästerier & Föreningar</h1>
      <a
        href="/"
...
function OrganizationModal({ org, onClose }: { org: OrgRow; onClose: () => void }) {
